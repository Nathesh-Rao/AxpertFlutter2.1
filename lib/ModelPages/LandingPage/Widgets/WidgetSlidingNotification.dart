  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: HexColor("F5F5F5")),
        child: Obx(() => Stack(
              children: [
                CarouselSlider(
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color:
                                  (Theme.of(context).brightness == Brightness.dark ? Colors.white : HexColor("133884"))
