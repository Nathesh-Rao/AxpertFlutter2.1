                  ...
                  children: [
                        ...
                        forgetPasswordController.showTimer.value
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(25), border: Border.all(width: 2, color: MyColors.blue2)),
                            child: Text(
                              "Resend OTP",
                              style: TextStyle(
                                  color: MyColors.blue2, fontFamily: 'redhabold', fontSize: MediaQuery
                                  .of(context)
                                  .size
                                  .height * 0.01),
                            ),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        errorText: forgetPasswordController.otpError.value == "" ? null : forgetPasswordController.otpError.value,
                        hintText: 'OTP',
                    ...
                    TextField(
                      ...
                      //  enabled: false,
                      decoration: InputDecoration(
                        errorText: forgetPasswordController.passError.value == "" ? null : forgetPasswordController.passError.value,
                        errorMaxLines: 2,
                    ...
                    TextField(
                      ...
                      //  enabled: false,
                      decoration: InputDecoration(
                        errorText: forgetPasswordController.conPassError.value == "" ? null : forgetPasswordController.conPassError.value,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: const LinearGradient(
                              colors: [MyColors.blue1, MyColors.blue1], begin: Alignment.bottomRight, end: Alignment.topLeft),
                        ),
                        child: Center(
                          child: Text(
                            'Submit',
                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      child: Text(
                        ...
                        style:
                        TextStyle(fontWeight: FontWeight.normal, fontSize: MediaQuery
                            .of(context)
                            .size
                            .height * 0.02, color: MyColors.blue2),
                      ),
                    ),
                    SizedBox(height: 30),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'User Name',
                        errorText: forgetPasswordController.errUserName.value == "" ? null : forgetPasswordController.errUserName.value,
                        hintStyle: const TextStyle(
                          fontSize: 15,
                        ),
                        filled: true,
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Email',
                        errorText: forgetPasswordController.emailError.value == "" ? null : forgetPasswordController.emailError.value,
                        hintStyle: const TextStyle(
                          fontSize: 15,
                        ),
                        filled: true,
