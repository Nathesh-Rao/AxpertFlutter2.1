...
class _WebViewCalendarState extends State<WebViewCalendar> {
  ...
  //                   _handleRefresh();
  //                 });
  //                 //WebViewdashboard(widget.weburl,widget.webtitle,widget.locationpermission);
  //               }
  //             },
  //             child: const Text('OK'),
  //           ),
      ...
      body: Builder(builder: (BuildContext context) {
        return Stack(children: <Widget>[
          InAppWebView(
            ...
            // geolocationEnabled: widget.locationpermission,
...
//               onPressed: () async {
//                 final String url = (await controller.data!.getUrl().toString())!;
//                 // ignore: deprecated_member_use
//
...
//   }
//
//   Future<void> _onShowUserAgent(InAppWebViewController controller, BuildContext context) async {
//     // Send a message with the user agent string to the Toaster JavaScript channel we registered
//     // with the WebView.
//     // await controller.runJavascript('Toaster.postMessage("User Agent: " + navigator.userAgent);');
//   }
//
//   Future<void> _onListCookies(InAppWebViewController controller, BuildContext context) async {
...
//
//     content:
//     Text('Added a test entry to cache.');
//   }
//
...
//   }
//
//   Future<void> _toLocationExample(WebViewController controller, BuildContext context) async {
