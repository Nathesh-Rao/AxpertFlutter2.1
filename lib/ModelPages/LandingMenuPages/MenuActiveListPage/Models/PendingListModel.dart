...
class PendingListModel {
  ...
  PendingListModel({
    ...
    required this.defrettext,
    required this.rejectreasons,
    required this.defregtext,
    required this.recordid,
    required this.approvalcomments,
    required this.rejectcomments,
    required this.returncomments,
    required this.rectype,
    required this.msgtype,
    required this.returnable,
    required this.initiator,
    required this.initiator_approval,
    required this.displaysubtitle,
    required this.amendment,
    required this.allowsend,
    required this.allowsendflg,
    required this.cmsg_appcheck,
    required this.cmsg_return,
    required this.cmsg_reject,
    required this.showbuttons,
    required this.hlink_transid,
    required this.hlink_params,
  });
